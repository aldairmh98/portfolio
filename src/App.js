                    ...
                    <div className="row">
                        <div className="col-md-8 d-flex justify-content-center align-items-center">
                            <p className="mt-3 text text-justify">
                                Junior Software Develeoper, from Córdoba, Veracruz. Universidad Veracruzana graduated
                                and able for residence change. I have worked on projects developed in Java, Javascript,
                                PHP y Python, interested in learning and developing new technicals and personals skills.
                            </p>
                        </div>
                        <div className="col-md-4">
                            <img src={'/portfolio/undraw_preferences_popup_wbfw.svg'} style={{width: '80%'}}></img>
                        </div>
                    </div>
                    ...
                    {/*<div className="container shadow"
                        ...
                        <div className="row">
                            <div className="col-sm-6 mb-3">
                                <img src="/portfolio/undraw_code_typing_7jnv.svg"
                                     style={{width: '80%', alignSelf: 'center', justifySelf: 'center'}}></img>
                            </div>
                            <div className="col-sm-6 mb-3">
                                {
                                    languages.map(
                            ...
                            <br></br>
                            <div className="col-sm-6 mt-3">
                                <img style={{width: '100%', height: 300}} className='img-responsive'
                                     src='/portfolio/undraw_percentages_0rur.svg'></img>
                            </div>
                        </div>
                    </div>*/}
                </section>
                <section className={'jumbotron'} id={'experience'} style={{backgroundColor: 'whitesmoke'}}>
                    ...
                    <div id="show_case" className='container shadow'
                        ...
                        <div className='mt-3'
                            ...
                            <ButtonGroup aria-label="Button Group">
                                <Button onClick={(e) => {
                                    e.preventDefault();
                                    let project = this.state.projects.mobile;
                                    this.setState({project, active_mobile: project.projects[0]});
                                }} variant="secondary">Mobile</Button>
                                <Button onClick={(e) => {
                                    e.preventDefault();
                                    let project = this.state.projects.web;
                                    this.setState({project, active_mobile: project.projects[0]});
                                }} variant="secondary">Web</Button>
                            </ButtonGroup>
                        </div>
...

                                        {
                                            this.state.fetching ? <Loading></Loading> : <div>
                                                ...
                                                <img className='img-responsive'
                                                     src={this.state.project.id === 1 ? '/portfolio/smartphone.svg' : '/portfolio/computer.svg'}
                                                     alt="logo"/>
                                                <p className='mt-3'>Click on each item to watch Screens</p>
                                                <ul className="list-unstyled">
                                                    {
                                                        this.state.project.projects.map(
                                                            (app, index) => <li style={{cursor: 'pointer'}} key={index}
                                                                                onClick={() => {
                                    ...
                                    {this.state.fetching ? <Loading></Loading> :
                                        <div>
                                            <h6 className='text-center mb-3 mt-3'>
                                                <b>{this.state.active_mobile.title}</b></h6>
                                            <Carousel
